...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/mwendellsmce/meu_portfolio_js13.git
   ```
...
- Layout **responsivo**
- Paleta de cores harmônica com tons de azul e branco
...
🔗 https://mwendellsmce.github.io/meu_portfolio_js13/
